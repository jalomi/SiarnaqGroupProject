...
LevelBuilderApplication a;
	...
	{
		SelectMultiplierPercentController sspc=new SelectMultiplierPercentController(a.model, a, 1);
		JTextField tb=a.getInputPanel().getPercentx2();
		tb.setText("55");
		sspc.update(tb);
		
		assertEquals(a.model.getPercentM(1), 0.55);
		assertEquals(a.model.getPercentM(0), 0.45);
	}
